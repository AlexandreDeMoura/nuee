...
export interface RepositionTerritoryInput {
  position_x: number;
  position_y: number;
}

export interface TerritoryPositionUpdate extends RepositionTerritoryInput {
  territory_id: string;
}

export interface BatchRepositionTerritoriesInput {
  positions: TerritoryPositionUpdate[];
}
