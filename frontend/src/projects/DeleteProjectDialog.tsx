...
interface DeleteProjectDialogProps {
  ...
  onDeleted: () => void;
  project: Project;
  requestDelete?: ProjectDeleteRequest;
}
...
export function DeleteProjectDialog({
  ...
  async function confirmDelete() {
    ...
    try {
      await requestDelete(project.id, controller.signal);
      ...
      >
        <div className="flex gap-3.5 px-5 pt-5 pb-[18px] sm:px-[22px]">
          <span className="grid size-[38px] shrink-0 place-items-center rounded-[10px] bg-[#fbf1f0] text-[#b4544e]">
            <Trash2 className="size-[19px]" strokeWidth={1.8} aria-hidden="true" />
          </span>
          <div className="min-w-0">
            ...
            <p
              ...
              id={descriptionId}
            >
              Its bubbles, territories, discussions, and documents will be deleted
