      ...
      <div className="rounded-xl border border-[#d7dee7] bg-white p-2.5 shadow-[0_1px_2px_rgba(30,39,51,0.04)] focus-within:border-[#3f63a8] focus-within:ring-3 focus-within:ring-[#3f63a8]/10">
        <div className="flex items-end gap-2.5">
          <textarea
            ...
            className="scrollbar-subtle min-h-[50px] flex-1 resize-none overflow-y-hidden overscroll-contain border-0 bg-transparent px-2.5 py-2.5 text-[15.5px] leading-[1.5] text-[#1e2733] outline-none placeholder:text-[#a7b1be] disabled:cursor-not-allowed disabled:text-[#7f8b99]"
